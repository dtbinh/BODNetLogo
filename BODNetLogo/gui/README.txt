...
This is the directory for the GUI code for BODNetLogo


###############################################################################################################################
###############################################################################################################################

This class files contain the graphical interface for BODNetLogo.

StartScreen, MainUI, and AddAgent collect the various data from the user needed to load a BODNetLogo simulation

SimulationController allows the user to control the control loop of BODNetLogo.
