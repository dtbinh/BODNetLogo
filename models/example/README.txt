...
This is an example model for the BODNetLogo abm program, 

###############################################################################################################################
###############################################################################################################################
to use it:
#ensure you have a correctly configured version of BODNetLogo
#open wolfSheep.bnconfig and correct the paths to the nlogo and lap files
#run BODNetLogo, choose open a config file and select wolfSheep.bnconfig
#choose load simulation
#once NetLogo has loaded the simulation can be started using the BODNetLogo simulation controller window
